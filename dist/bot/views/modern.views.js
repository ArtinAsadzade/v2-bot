...
function registerModernViews() {
    (0, panel_ui_1.registerView)("home", async (ctx) => {
        ...
        const keyboard = [
            [{ text: "🛍 فروشگاه", action: (0, panel_ui_1.callbackFor)("shop.categories") }, { text: "💳 کیف پول", action: (0, panel_ui_1.callbackFor)("wallet") }],
            [{ text: "➕ شارژ حساب", action: (0, panel_ui_1.callbackFor)("deposit") }, { text: "🎧 پشتیبانی", action: (0, panel_ui_1.callbackFor)("support") }],
            [{ text: "🎁 دعوت دوستان", action: (0, panel_ui_1.callbackFor)("referral") }, { text: "🆓 اکانت رایگان", action: (0, panel_ui_1.callbackFor)("freeAccount") }],
        ];
        if (isAdmin)
