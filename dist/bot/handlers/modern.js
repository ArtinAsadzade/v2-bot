...
📤 پس از پرداخت، تصویر رسید را همین‌جا ارسال کنید.`, { reply_markup: { inline_keyboard: [[{ text: "🔙 بازگشت", callback_data: (0, panel_ui_1.callbackFor)("deposit") }, { text: "🏠 خانه", callback_data: (0, panel_ui_1.callbackFor)("home") }], [{ text: "❌ لغو عملیات", callback_data: "flow:cancel" }]] } });
        }
        catch (error) {
