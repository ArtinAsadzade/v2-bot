...
test("admin shop dashboard groups only shop product and category actions", () => {
  for (const label of ["🛍 داشبورد فروشگاه", "📦 محصولات", "🗂 دسته‌بندی‌ها", "➕ افزودن محصول", "➕ افزودن دسته‌بندی", "✅ محصولات فعال", "⛔ محصولات غیرفعال", "🔄 سینک با Xray", "🆓 اکانت تست", "📦 بروزرسانی گروهی اینباند"]) {
