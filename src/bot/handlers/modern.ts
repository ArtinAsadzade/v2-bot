...
import { goBack, parseNavAction, renderPanel, callbackFor, actionFor } from "../navigation/panel-ui";
...
📤 پس از پرداخت، تصویر رسید را همین‌جا ارسال کنید.`, { reply_markup: { inline_keyboard: [[{ text: "🔙 بازگشت", callback_data: callbackFor("deposit") }, { text: "🏠 خانه", callback_data: callbackFor("home") }], [{ text: "❌ لغو عملیات", callback_data: "flow:cancel" }]] } });
    } catch (error) {
