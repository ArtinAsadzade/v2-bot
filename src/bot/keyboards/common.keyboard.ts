...
export const homeKeyboard = (isAdmin: boolean): UiKeyboard => {
  const keyboard: UiKeyboard = [
    ...
    navRow({ text: "💳 کیف پول", view: "wallet", tone: "primary" }, { text: "🎟 دعوت دوستان", view: "referral", tone: "success" }),
    navRow({ text: "🆘 پشتیبانی", view: "support", tone: "primary" }, { text: "📘 راهنما", view: "help", tone: "neutral" }),
  ];
